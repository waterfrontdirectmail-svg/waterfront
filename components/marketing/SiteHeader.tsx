          ...
          <nav className="container-max px-4 py-3 flex flex-col">
            {navLinks.map((link) => (
              <a
                ...
                className="text-primary-foreground/80 hover:text-brass-gold py-3 text-sm font-medium transition-colors border-b border-primary-foreground/[0.06] last:border-b-0"
              >
                {link.label}
              </a>
            ))}
            ...
            <a
              href="#get-started"
              onClick={() => setMobileOpen(false)}
              className="mt-4 mb-2 bg-brass-gold hover:bg-brass-gold-hover text-primary-foreground py-3 rounded-lg text-sm font-semibold text-center transition-colors"
            >
